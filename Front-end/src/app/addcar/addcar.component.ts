...
export class SomeModel {
    ...
    public img : string;
    public bodyCarSend : string;
    public engineVolumeSend : string;
    public gearboxSend : string;
    public engineTypeSend : string;
    public urlSend : string;
    public textSend : string;
    public carNameSend : string;
}
...
export class AddcarComponent implements OnInit {
    ...
    getModel() {
        ...
        //TODO: may be can use .map method?
        let set = new Set()
